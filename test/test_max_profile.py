...
def test_calc_steps_being_moved_1():
  # Given
  target_steps = 100
...
def test_calc_steps_being_moved_3():
  # Given
  target_steps = -100
  previous_target_steps = -100
  # When
...
def test_calc_steps_being_moved_4():
  # Given
  target_steps = 100
...
def test_calc_steps_being_moved_2():
  # Given
  target_steps = 100
  previous_target_steps = 50
  # When
...
def test_adjust_deceleration_steps_overlap_0():
...
def test_adjust_deceleration_steps_overlap_1():
  """ Overlapping accel and decel ramps """
  # Given
...
def test_is_accelerating_negative():
  # Given
  steps_being_moved = 20
  distance_to_go = -16
  acceleration_steps = 5
...
def test_compute_new_speed_1():
  ...
  # called by set_target_speed(): profile.compute_new_speed()
  # Then
...
def test_acceleration_increment_steps_0():
  # Given
...
def test_acceleration_increment_steps():
  # Given
  acceleration_steps = 10
  target_speed_steps_per_sec = 1000
  max_start_speed = 100
...
if __name__ == '__main__':
  test_constrain()
  test_calc_steps_being_moved_2()
  test_calc_steps_being_moved_3()
  test_calc_steps_being_moved_4()
  test_calc_steps_being_moved_1()
  test_adjust_deceleration_steps_overlap_0()
  test_adjust_deceleration_steps_overlap_1()
  test_acceleration_increment_steps()
  test_acceleration_increment_steps_0()
  test_is_accelerating_true()
  test_is_accelerating_false()
  test_is_accelerating_negative()
  test_is_decelerating_1()
  test_is_decelerating_2()
  test_is_decelerating_3()
  test_is_decelerating_4()
  test_compute_new_speed_0()
  test_compute_new_speed_1()
